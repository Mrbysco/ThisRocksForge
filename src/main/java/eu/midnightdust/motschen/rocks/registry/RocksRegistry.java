...
public class RocksRegistry {
	...
	public static final RegistryObject<Item> MANGROVE_STICK_ITEM = ITEMS.register("mangrove_stick", () -> new BlockItem(MANGROVE_STICK.get(), new Item.Properties().tab(Rocks.RocksGroup)));
