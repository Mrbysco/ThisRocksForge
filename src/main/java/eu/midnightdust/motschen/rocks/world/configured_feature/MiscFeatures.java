...
public class MiscFeatures {
	...
	public static ConfiguredFeature<?, ?> UNDERWATER_STARFISH_FEATURE = new ConfiguredFeature<>(FeatureRegistry.UNDERWATER_STARFISH_FEATURE.get(),
			new ProbabilityFeatureConfiguration(1));
	public static ConfiguredFeature<?, ?> UNDERWATER_SEASHELL_FEATURE = new ConfiguredFeature<>(FeatureRegistry.UNDERWATER_SEASHELL_FEATURE.get(),
			new ProbabilityFeatureConfiguration(1));
	public static ConfiguredFeature<?, ?> SNOWY_GEYSER_FEATURE = new ConfiguredFeature<>(FeatureRegistry.SNOWY_GEYSER_FEATURE.get(),
			new ProbabilityFeatureConfiguration(1));

	public static PlacedFeature SEASHELL_PLACED_FEATURE = new PlacedFeature(Holder.direct(SEASHELL_FEATURE),
			List.of(CountPlacement.of(1), RarityFilter.onAverageOnceEvery(1), InSquarePlacement.spread(),
					...
					BlockPredicateFilter.forPredicate(BlockPredicate.allOf(BlockPredicate.ONLY_IN_AIR_PREDICATE,
							BlockPredicate.matchesBlocks(new Vec3i(0, -1, 0),
									ImmutableList.of(Blocks.SAND, Blocks.SANDSTONE, Blocks.RED_SAND, Blocks.RED_SANDSTONE))))));
	public static PlacedFeature STARFISH_PLACED_FEATURE = new PlacedFeature(Holder.direct(STARFISH_FEATURE),
			List.of(CountPlacement.of(1), RarityFilter.onAverageOnceEvery(1), InSquarePlacement.spread(),
					PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome(),
					BlockPredicateFilter.forPredicate(BlockPredicate.allOf(BlockPredicate.ONLY_IN_AIR_PREDICATE,
							BlockPredicate.matchesBlocks(new Vec3i(0, -1, 0),
									ImmutableList.of(Blocks.SAND, Blocks.SANDSTONE, Blocks.RED_SAND, Blocks.RED_SANDSTONE))))));
	public static PlacedFeature PINECONE_PLACED_FEATURE = new PlacedFeature(Holder.direct(PINECONE_FEATURE),
			StickFeatures.getModifiers(1, 5, Blocks.GRASS_BLOCK, Blocks.PODZOL, Blocks.COBBLESTONE, Blocks.MOSSY_COBBLESTONE));
	public static PlacedFeature UNDERWATER_SEASHELL_PLACED_FEATURE =
			new PlacedFeature(Holder.direct(UNDERWATER_SEASHELL_FEATURE), List.of(CountPlacement.of(3),
					RarityFilter.onAverageOnceEvery(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
	public static PlacedFeature UNDERWATER_STARFISH_PLACED_FEATURE =
			new PlacedFeature(Holder.direct(UNDERWATER_STARFISH_FEATURE), List.of(CountPlacement.of(3),
					RarityFilter.onAverageOnceEvery(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
	public static PlacedFeature SNOWY_GEYSER_PLACED_FEATURE =
			new PlacedFeature(Holder.direct(SNOWY_GEYSER_FEATURE), List.of(CountPlacement.of(3),
					RarityFilter.onAverageOnceEvery(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
